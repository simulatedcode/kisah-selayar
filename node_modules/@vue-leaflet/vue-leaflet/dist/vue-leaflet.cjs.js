...
var script = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(circle(props.latLng, options));
...
var script$1 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(circleMarker(props.latLng, options));
...
var script$2 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(new LControl(options));
      propsBinder(methods, leafletRef.value, props);
...
var script$3 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(control.attribution(options));
      propsBinder(methods, leafletRef.value, props);
      registerControl({ leafletObject: leafletRef.value });
      vue.nextTick(() => context.emit("ready", leafletRef.value));
    });
...
var script$4 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(control.layers(null, null, options));
...
var script$5 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(control.scale(options));
      propsBinder(methods, leafletRef.value, props);
      registerControl({ leafletObject: leafletRef.value });
      vue.nextTick(() => context.emit("ready", leafletRef.value));
    });
...
var script$6 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(control.zoom(options));
      propsBinder(methods, leafletRef.value, props);
      registerControl({ leafletObject: leafletRef.value });
      vue.nextTick(() => context.emit("ready", leafletRef.value));
    });
...
var script$7 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(featureGroup(options));
...
var script$8 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(geoJSON(props.geojson, options));
...
var script$9 = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(new GLayer(options));
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      const { layerGroup, DomEvent } = useGlobalLeaflet
        ? WINDOW_OR_GLOBAL.L
        : await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('leaflet/dist/leaflet-src.esm')); });
      leafletRef.value = vue.markRaw(layerGroup(props.options));
...
var script$d = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      blueprint.leafletRef = vue.markRaw(map(root.value, options));
...
var script$e = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(marker(props.latLng, options));
    ...
    vue.onBeforeUnmount(() => cancelDebounces(eventHandlers));
...
var script$f = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(polygon(props.latLngs, options));
...
var script$g = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(polyline(props.latLngs, options));
...
var script$h = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(popup(options));
...
var script$i = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(rectangle(bounds, options));
...
var script$j = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(tileLayer(props.url, options));
...
var script$k = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(tooltip(options));
...
var script$l = {
  ...
  setup(props, context) {
    ...
    vue.onMounted(async () => {
      ...
      leafletRef.value = vue.markRaw(tileLayer.wms(props.url, options));
